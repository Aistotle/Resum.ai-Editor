...
import { Share, Plus, Trash2, Pencil } from '../Icons';
...
const ProfilesEditor: React.FC<ProfilesEditorProps> = ({ data, onOpenModal, onRemoveItem, t }) => {
    const profiles = data.profiles || [];
    return (
        <SectionWrapper id="profiles" icon={Share} title={t('sectionProfiles')}>
