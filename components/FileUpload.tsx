  ...
  return (
    <div className="w-full max-w-lg mx-auto mt-8">
      <div
        ...
        isDragging ? 'border-purple-400 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-900/20 dark:via-purple-900/20 dark:to-pink-900/20' : 'border-border bg-foreground hover:border-purple-400/50'}`}
      >
